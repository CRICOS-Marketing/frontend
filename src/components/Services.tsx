...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 px-4 bg-[#e34d00]">
      <div className="container mx-auto text-left">
        ...
        <div className="flex justify-center mt-12">
          <button
            className="bg-[#ffa175] hover:bg-[#293c4d] border border-gray-400 px-8 py-4 rounded-3xl text-black font-semibold text-md md:text-lg transition duration-300 ease-in-out"
            style={{ fontFamily: "PT Serif" }}
          >
            Book a Consultation
          </button>
